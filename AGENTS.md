...
This project is indexed by GitNexus as **SIN-Hermes-V15-Patches** (1277 symbols, 1373 relationships, 8 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/SIN-Hermes-V15-Patches/context` | Codebase overview, check index freshness |
| `gitnexus://repo/SIN-Hermes-V15-Patches/clusters` | All functional areas |
| `gitnexus://repo/SIN-Hermes-V15-Patches/processes` | All execution flows |
| `gitnexus://repo/SIN-Hermes-V15-Patches/process/{name}` | Step-by-step execution trace |
